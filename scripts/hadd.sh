...
if [[ $1 == *"Dilep"* ]]; then
    ...
    if [[ $1 == *"WVZ2017_v0.1.12."* ]] || [[ $1 == *"WVZ2018_v0.1.12."* ]] || [[ $1 == *"WVZMVA2017_v0.1."* ]] || [[ $1 == *"WVZMVA2018_v0.1."* ]]; then
        ...
        echo "hadd -f sig.root ${PREFIX}www_amcatnlo_1_results.root ${PREFIX}wwz_amcatnlo_1_results.root ${PREFIX}wzz_amcatnlo_1_results.root ${PREFIX}zzz_4l_amcatnlo_1_results.root ${PREFIX}wh_ww_amcatnlo_1_results.root ${PREFIX}wh_zz_amcatnlo_1_results.root ${PREFIX}zh_ww_4l_powheg_1_results.root ${PREFIX}ggzh_ww_4l_powheg_1_results.root ${PREFIX}zh_zz_amcatnlo_1_results.root ${PREFIX}wwz_4l2v_amcatnlo_1_results.root" >> .hadd.cmds.txt
    elif [[ $1 == *"WVZMVA2016_v0.1."* ]]; then
    ...
    elif [[ $1 == *"WVZMVA2017_v0.1."* ]] || [[ $1 == *"WVZMVA2018_v0.1."* ]]; then
    ...
    if [[ $1 == *"WVZMVA2017_v0.1."* ]] || [[ $1 == *"WVZMVA2018_v0.1."* ]]; then
        echo "hadd -f zzz.root ${PREFIX}zzz_4l_amcatnlo_1_results.root ${PREFIX}zh_zz_amcatnlo_1_results.root" >> .hadd.cmds.txt
    else
        echo "hadd -f zzz.root ${PREFIX}zzz_amcatnlo_1_results.root ${PREFIX}zh_zz_amcatnlo_1_results.root" >> .hadd.cmds.txt
    fi
    if [[ $1 == *"WVZMVA2016_v0.1."* ]] || [[ $1 == *"WVZMVA2017_v0.1."* ]] || [[ $1 == *"WVZMVA2018_v0.1."* ]]; then
    ...
    echo "hadd -f othernoh.root ${PREFIX}wzg_amcatnlo_1_results.root ${PREFIX}dy_m1050_madgraph_1_results.root ${PREFIX}dy_m50_madgraph_1_results.root ${PREFIX}ttbar_dilep_madgraph_1_results.root ${PREFIX}zg_llg_amcatnlo_1_results.root ${PREFIX}sts_4f_leptonic_madgraph_1_results.root ${PREFIX}tZq_ll_madgraph_1_results.root ${PREFIX}ttw_lnu_amcatnlo_1_results.root ${PREFIX}tw_antitopnofullhad_powheg_1_results.root ${PREFIX}tw_topnofullhad_powheg_1_results.root ${PREFIX}ww_2l_powheg_1_results.root ${PREFIX}wwg_amcatnlo_1_results.root ${PREFIX}tttt_incl_amcatnlo_1_results.root" >> .hadd.cmds.txt

    echo "hadd -f othernodyttbar.root ${PREFIX}sts_4f_leptonic_madgraph_1_results.root ${PREFIX}tZq_ll_madgraph_1_results.root ${PREFIX}ttw_lnu_amcatnlo_1_results.root ${PREFIX}tw_antitopnofullhad_powheg_1_results.root ${PREFIX}tw_topnofullhad_powheg_1_results.root ${PREFIX}ww_2l_powheg_1_results.root ${PREFIX}wwg_amcatnlo_1_results.root ${PREFIX}wzg_amcatnlo_1_results.root ${PREFIX}ggh_hzz4l_powheg_1_results.root ${PREFIX}vh_nonbbwwzz_amcatnlo_1_results.root ${PREFIX}tth_nonbb_powheg_1_results.root" >> .hadd.cmds.txt
fi
