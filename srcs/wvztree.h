...
// makeCMS3ClassFiles("/nfs-7/userdata/phchang/babies/WVZMVA2018_v0.1.21/wwz_4l2v_amcatnlo_1.root", "t", "wvztree", "tas", "wvz")
...
class wvztree {
 ...
 protected: 
  ...
  float    lumival_;
  TBranch *lumival_branch;
  bool     lumival_isLoaded;
  float    puwgt_;
  ...
  vector<float> *lep_relIso03EAv4wLep_;
  TBranch *lep_relIso03EAv4wLep_branch;
  bool     lep_relIso03EAv4wLep_isLoaded;
  ...
  float    met_orig_up_pt_;
  TBranch *met_orig_up_pt_branch;
  bool     met_orig_up_pt_isLoaded;
  float    met_orig_up_phi_;
  TBranch *met_orig_up_phi_branch;
  bool     met_orig_up_phi_isLoaded;
  float    met_orig_dn_pt_;
  TBranch *met_orig_dn_pt_branch;
  bool     met_orig_dn_pt_isLoaded;
  float    met_orig_dn_phi_;
  TBranch *met_orig_dn_phi_branch;
  bool     met_orig_dn_phi_isLoaded;
  ...
  vector<float> *rawjets_btag_score_;
  TBranch *rawjets_btag_score_branch;
  bool     rawjets_btag_score_isLoaded;
...
void LoadAllBranches(); 
  ...
  const vector<float> &lep_relIso03EAv4wLep();
  ...
  const float &met_orig_up_pt();
  const float &met_orig_up_phi();
  const float &met_orig_dn_pt();
  const float &met_orig_dn_phi();
  ...
  const vector<float> &rawjets_btag_score();
